...
async function getLolData() {
  ...
  if (!deduped.length) {
    const games = [
      ...
      serializeEsport({ matchId: 'demo-LoL-LCK-1', label: 'T1 vs Gen.G', status: 'Demo fallback (upstream unavailable)', startTime: futureIso(9), league: 'LoL LCK', streamUrl: LOL_TWITCH_BY_REGION.LCK })
    ];
